Here are 2 articles about my learning about github.

- [My first try to access Github with CLI](#my-first-try-to-access-github-with-cli)
- [Github Learning - create a local repo and push to remote](#github-learning---create-a-local-repo-and-push-to-remote)
